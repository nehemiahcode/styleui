        ...
        <main className="py-14">
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                <div className="max-w-xl space-y-3">
                    ...
                    <p>
                        We&quotre here to help and answer any question you might have, We look forward to hearing from you .
                    </p>
                </div>
                <div>
  ...
  return (
    <section className=" px-2 my-5">
      <h1 className="font-bold text-white dark:text-black text-3xl">
        Tailwind CSS Contact Sections
      </h1>
      <p className="py-2 text-white dark:text-black">
        Beautifully designed, fully responsive, expertly crafted contact section
        examples
      </p>
      <div className="py-4">
        <TabLayout>
          <Tab key={"preview"} title={<TabView />}>
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 gap-12 md:px-8 lg:flex">
              <div className="max-w-md">
                <h3 className="dark:text-gray-800 text-white text-2xl font-semibold sm:text-4xl">
                  Let&quot;s connect
                </h3>
                <p className="mt-3 dark:text-gray-800 text-white">
              ...
              <div>
                <ul className="mt-12 gap-y-6 gap-x-12 items-center md:flex lg:gap-x-0 lg:mt-0">
                  {contactMethods.map((item, idx) => (
                    ...
                    >
                      <div className="w-12 h-12 rounded-full border flex items-center justify-center dark:text-gray-800 text-white">
                        {item.icon}
                      </div>
                      <h4 className="dark:text-gray-800 text-white text-lg font-medium xl:text-xl">
                        {item.title}
                      </h4>
          ...
          <Tab code={code1} title={<TabCode />}>
            <Codelayout code={code1} filename={"./components/contact.jsx"} />
          </Tab>
        </TabLayout>
      </div>
      <div className="py-4">
        <TabLayout>
            ...
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
              <div className="  grid grid-cols-1 md:grid-cols-2 w-full">
                <div className="max-w-lg space-y-3">
                  ...
                  <p className="dark:text-gray-800 text-white text-3xl font-semibold sm:text-4xl">
                    Let&quot;s know how we can help
                  </p>
                  <p className="dark:text-gray-800 text-white">
                    We&quot;re here to help and answer any question you might
                    have, We look forward to hearing from you! Please fill out
                    the form, or us the contact information bellow .
                  </p>
                  <div>
                    <ul className="mt-6 flex flex-wrap gap-x-10 gap-y-6 items-center">
                      {contactMethods2.map((item, idx) => (
                        <li key={idx} className="flex items-center gap-x-3">
                          ...
                          <p className="dark:text-gray-800 text-white">{item.contact}</p>
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md">
                  <form
                    onSubmit={(e) => e.preventDefault()}
                    className="space-y-5 dark:text-gray-800 text-white" 
                  >
                    <div>
          ...
          <Tab code={code2} title={<TabCode />}>
            <Codelayout code={code2} filename={"./components/contact.jsx"} />
          </Tab>
        </TabLayout>
      </div>
      <div className="py-4">
        <TabLayout>
          <Tab key={"preview"} title={<TabView />}>
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
              <div className="max-w-xl space-y-3">
                <h3 className="text-indigo-600 font-semibold">Contact</h3>
                <p className="dark:text-gray-800 text-white text-whitetext-3xl font-semibold sm:text-4xl">
                  Let us know how we can help
                </p>
                <p className="dark:text-gray-800 text-white">
                  We&quot;re here to help and answer any question you might
              ...
              <div>
                <ul className="mt-12 flex flex-wrap gap-x-12 gap-y-6 items-center lg:gap-x-24">
                  {contactMethods3.map((item, idx) => (
                    <li key={idx}>
                      <h4 className="dark:text-gray-800 text-white text-lg font-medium">
                        {item.title}
                      </h4>
                      <div className="mt-3 flex items-center gap-x-3">
                        <div className="flex-none dark:text-gray-800 text-white">
                          {item.icon}
                        </div>
                        <p className="dark:text-gray-800 text-white">{item.contact}</p>
                      </div>
          ...
          <Tab code={code3} title={<TabCode />}>
            <Codelayout code={code3} filename={"./components/contact.jsx"} />
          </Tab>
        </TabLayout>
      </div>
    </section>
