...
export default function Section1() {
  ...
  return (
    <section className="  w-full h-auto lg:px-16 md:px-5 xl:px-20 sm:px-3 px-3">
      ...
      <div className=" border-b-1 border-slate-600 my-3 lg:w-[50%] sm:w-[80%] ">
        <h1
          id="what-is-styleui"
      ...
      <div className=" my-3 lg:w-[50%]  sm:w-[80%]">
        <h1
      ...
      <div className=" my-3 lg:w-[50%]  sm:w-[80%]">
        ...
        <p id="2" className="  text-white py-3 text-base dark:text-black">
